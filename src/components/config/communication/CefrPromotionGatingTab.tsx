    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white dark:bg-zinc-900 p-4 rounded-2xl border border-zinc-200 dark:border-zinc-800">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-4 py-1.5 text-xs font-black text-white bg-indigo-600 hover:bg-indigo-500 rounded-xl shadow-md transition-all disabled:opacity-40 self-start sm:self-auto"
        >
          <Save size={14} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="card p-5 space-y-3 border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900">
          ...
          <select
            ...
            className="w-full text-xs font-bold p-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 focus:ring-2 focus:ring-indigo-500/40"
          >
        ...
        <div className="card p-5 space-y-3 border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] font-black uppercase px-2 py-0.5 rounded-full bg-indigo-500/10 text-indigo-600 border border-indigo-500/20">
              Rule R10
            </span>
          </div>
          <p className="text-xs text-zinc-500 dark:text-zinc-400">
          ...
          <div className="space-y-2">
            <label className="flex items-center gap-2.5 p-2 rounded-xl border border-zinc-200 dark:border-zinc-700/60 bg-zinc-50 dark:bg-zinc-800/40 cursor-pointer">
              <input
                type="radio"
                name="gatePolicy"
                value="overall"
      ...
      {/* Summary Alert */}
      <div className="flex items-start gap-2.5 p-4 rounded-xl border border-indigo-500/20 bg-indigo-500/5 text-xs text-zinc-600 dark:text-zinc-300">
        <AlertTriangle size={15} className="text-indigo-600 dark:text-indigo-400 shrink-0 mt-0.5" />
        <div>
          <strong className="text-zinc-900 dark:text-zinc-100">Governance Impact:</strong> These policies directly govern the promotion readiness flags on individual scorecards and manager talent review dashboards. When an employee is in a gated grade, failing to meet the CEFR target flags the assessment with a <span className="text-rose-600 dark:text-rose-400 font-bold">GATED</span> status.
        </div>
      </div>
    </div>
  );
